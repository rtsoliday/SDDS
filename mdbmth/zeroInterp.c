/**
 * @file zeroInterp.c
 * @brief Implements the zeroInterp function for finding zeros of a function using successive interpolation.
 *
 * @copyright 
...
/**
 * @brief Finds the zero of a function within a specified interval using successive interpolation.
 *
 ...
 * @param _zero Acceptable tolerance for the zero, determining when to stop the interpolation.
 *
