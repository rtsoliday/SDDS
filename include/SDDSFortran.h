...
C     constants in the SDDS library.
      ...
      integer SDDS_LONGDOUBLE
      integer SDDS_DOUBLE
      integer SDDS_FLOAT
      integer SDDS_LONG64
      integer SDDS_ULONG64
      integer SDDS_LONG
      integer SDDS_ULONG
      integer SDDS_SHORT
      integer SDDS_USHORT
      ...
      parameter (SDDS_LONGDOUBLE = 1)
      parameter (SDDS_DOUBLE = 2)
      parameter (SDDS_FLOAT = 3)
      parameter (SDDS_LONG64 = 4)
      parameter (SDDS_ULONG64 = 5)
      parameter (SDDS_LONG = 6)
      parameter (SDDS_ULONG = 7)
      parameter (SDDS_SHORT = 8)
      parameter (SDDS_USHORT = 9)
      parameter (SDDS_STRING = 10)
      parameter (SDDS_CHARACTER = 11)
      parameter (SDDS_NUM_TYPES = 11)
