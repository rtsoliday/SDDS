...
/* cfftb1.f -- translated by f2c (version of 30 January 1990  16:02:04).
...
/* Subroutine */ int cfftb1_(integer *n, doublereal *c, doublereal *ch, 
	doublereal *wa, integer *ifac)
{
    ...
    integer na, nf, ip, iw, ix2, ix3, ix4, nac, ido, idl1;
