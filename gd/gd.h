...
BGD_EXPORT_DATA_PROT gdImagePtr gdImageCreate (int sx, int sy);

/* An alternate name for the above (2.0). */
#define gdImageCreatePalette gdImageCreate

/* Creates a truecolor image (millions of colors). */
BGD_EXPORT_DATA_PROT gdImagePtr gdImageCreateTrueColor (int sx, int sy);
...
BGD_EXPORT_DATA_PROT gdImagePtr gdImageCreateFromPng (FILE * fd);
...
BGD_EXPORT_DATA_PROT void gdImageDestroy (gdImagePtr im);
...
BGD_EXPORT_DATA_PROT void gdImageSetPixel (gdImagePtr im, int x, int y, int color);
...
BGD_EXPORT_DATA_PROT void gdImageLine (gdImagePtr im, int x1, int y1, int x2, int y2, int color);
...
BGD_EXPORT_DATA_PROT void gdImageFilledRectangle (gdImagePtr im, int x1, int y1, int x2, int y2,
					  int color);
...
BGD_EXPORT_DATA_PROT int gdImageColorAllocate (gdImagePtr im, int r, int g, int b);
...
BGD_EXPORT_DATA_PROT void gdImageColorTransparent (gdImagePtr im, int color);

BGD_EXPORT_DATA_PROT void gdImagePaletteCopy (gdImagePtr dst, gdImagePtr src);
...
BGD_EXPORT_DATA_PROT void gdImagePng (gdImagePtr im, FILE * out);
...
BGD_EXPORT_DATA_PROT void gdImageGd (gdImagePtr im, FILE * out);
...
BGD_EXPORT_DATA_PROT void gdImageSetBrush (gdImagePtr im, gdImagePtr brush);
...
BGD_EXPORT_DATA_PROT void gdImageInterlace (gdImagePtr im, int interlaceArg);
