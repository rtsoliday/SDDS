...
\item \textbf{switches:}
  ...
  \item {\tt -threads={\em number}} --- Specifies the number of threads for rank preprocessing and pairwise
    correlation computation. SDDS output row writes are performed serially. The default is 1.
  \end{itemize}
\item \textbf{see also:}
  \begin{itemize}
