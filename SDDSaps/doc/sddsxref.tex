...
sddsxref [-pipe[=input][,output]] [input] [xRefFile] [output]
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of reference files to read concurrently.
        The default is 1. SDDS output operations and row/column transfer operations are performed
        serially after the reference pages have been read.
    \end{itemize}
  \item \textbf{see also:}
    \begin{itemize}
