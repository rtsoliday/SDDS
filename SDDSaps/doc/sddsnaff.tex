...
sddsnaff [inputfile] [outputfile]
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of threads for independent dependent-column
        NAFF runs. SDDS output operations are performed serially. The default is 1.
