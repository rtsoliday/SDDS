...
sddsfft [-pipe=[input][,output]] [inputFile] [outputFile]
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of threads for per-column FFT preparation and result calculations. SDDS output operations are performed serially. The default is 1.
    \end{itemize}
