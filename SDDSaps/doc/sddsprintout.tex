...
\item {\bf see also:}
        ...
        \end{itemize}
\item {\bf Notes:} Use of \progref{sddsprintout} to create tables of ascii data to be read by other (non-SDDS) programs is not recommended.
  Better alternatives are \progref{sdds2stream}, \progref{sdds2spreadsheet}, and \progref{sdds2plaindata}.
