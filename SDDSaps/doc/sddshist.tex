...
sddshist [-pipe=[input][,output]] [inputFile] [outputFile] \
  ...
  [-statistics] [-threads=number] [-verbose]
    \end{verbatim}
  \item \textbf{files:}
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of threads for histogram binning and statistics calculations where applicable. The default is 1.
    \end{itemize}
  \item \textbf{see also:}
    \begin{itemize}
