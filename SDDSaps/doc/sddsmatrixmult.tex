...
sddsmatrixmult response correctorChange bpmExpectedChange
  ...
  \item \textbf{synopsis:}
    \begin{verbatim}
    sddsmatrixmult [-pipe=[input][,output]] [file1] file2 [output] [-commute] [-reuse] [-threads=number] [-verbose] [-ascii]
    \end{verbatim}
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of threads for matrix multiplication. SDDS page I/O is performed serially. The default is 1.
