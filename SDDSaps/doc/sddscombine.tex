\begin{sddsprog}{sddscombine}
  ...
  \item \textbf{switches:}
    \begin{itemize}
      ...
      \item \verb|-threads=number| --- Specifies the number of input files to read concurrently in ordinary combine mode. The default is 1. At most this many input files have a page loaded at one time, and output pages are still written serially in command-line order. Merge, collapse, append, and recover modes are processed serially.
