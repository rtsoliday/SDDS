\begin{sddsprog}{sddsrunstats}
  ...
  \item \textbf{switches:}
    ...
    \item {\tt -threads=\emph{number}} --- Specifies the number of threads for per-column running-statistic calculations. The default is 1. SDDS input and output operations are performed serially.
    \end{itemize}
