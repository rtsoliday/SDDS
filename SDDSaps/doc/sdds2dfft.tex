...
sdds2dfft [-pipe=[input][,output]] [inputFile] [outputFile]
  ...
  \item \textbf{switches:}
    \begin{itemize}
      \item \verb|-threads=number| --- Specifies the number of threads for row-wise FFT work. SDDS input and output operations are performed serially. The default is 1.
    \end{itemize}
