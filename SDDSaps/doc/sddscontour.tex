...
sddscontour example.sdds -scales=0,1,0,1 -shade
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{2D-shade-plot.eps}}
...
sddscontour example.sdds -scales=0,1,0,1 -3d
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{3D-surface-plot.eps}}
...
# toggle wireframe on with 'g'
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{3D-surface-plot2.eps}}
...
# toggle wireframe on and surface off with 'g'
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{3D-surface-plot3.eps}}
...
sddscontour example.sdds -scales=0,1,0,1 -3d=bar
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{3D-bar-plot.eps}}
...
sddscontour example.sdds -scales=0,1,0,1 -3d=scatter
    \end{verbatim}
    \centerline{\includegraphics[width=4in]{3D-scatter-plot.eps}}
...
[-yeditstrings=<editCommand>]
        ...
        The {\em Index} column provides the x index so that {\em x = Index * delta1 + origin1}.  Columns {\em Ex\_n} contain field
        ...
        \begin{flushleft}{\tt \bf
            sddscontour sddscontour.input1 -columnmatch=Index,Ex* -ystrings=edit=\%/Ex\_//,sparse=10 -ylabel=y -shade
...
[-layout={\em nx},{\em ny}] [-ticksettings=xtime|ytime]
