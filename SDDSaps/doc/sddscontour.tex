...
\begin{itemize}
        ...
        \item \verb|3d| --- Displays the data as an interactive 3-dimensional surface (\verb|-3d| or \verb|-3d=surface|) or bar plot (\verb|-3d=bar|) that can be rotated with the mouse.\
