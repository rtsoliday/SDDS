...
sddsenvelope [-pipe=[input][,output]] [input] [output] [-copy=columnNames]
  ...
  \begin{itemize}
    ...
    \item \verb|-threads=\emph{number}| --- Specifies the number of threads for row-wise statistic calculations. The default is 1. SDDS input and output operations are performed serially.
  \end{itemize}
